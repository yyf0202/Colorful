...
//			    Distribution *= (2+specularpower) / (2*3.1415926535);
			...
			float CustomSpecularDistribution( float roughness, float3 lightDir , float3 view , float3 normal , float3 normalDetail )
			{
...
//				float3 normal = i.tangentDir * normalHeight.x + i.normal * normalHeight.z + i.bitangentDir * normalHeight.y;
				...
				CustomSpecularDistribution ( _OceanSpecularShiness , lightDirection , viewDirection , normal , detail )
